          ...
          if (annotation.annotationType() == PostMappingLeft.class || annotation.annotationType() == GetMappingLeft.class) {
            ...
            for (Method annotationMethod : annotationMethods) {
              ...
              if (methodRecordMap.get(fullPath) != null) {
                throw new RuntimeException("the route path: { " + fullPath + " } always exist, don't allow the same request path in a uriRelativeMethod");
              } else {
                ...
                methodRecordMap
                  .put(fullPath, new RouteMethodRecord(fullPath, requestWay, controllerMethod, controllerMethod.getDeclaringClass())
                  );
              }
            }
          }
